...
#define STRING_CONFIG_H_AUTHOR "(mickeymicks, SKR1.4T)" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 13 // using NTC 100K instead of PT100 (20)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Duplicator 6
  // M301 P9.12 I0.41 D50.98 // original
  // M301 P53.93 I4.34 D167.57 // new, recalibrated with NTC 100K TH
  #define DEFAULT_Kp 53.93
  #define DEFAULT_Ki 4.34
  #define DEFAULT_Kd 167.57
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.84, 80.84, 800.96, 99.1 } //default for D6
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.84, 80.84, 800.96, 186.63 } // tmc xyz (16 mstep), lv8729 e (32 mstep)
...
#define NOZZLE_TO_PROBE_OFFSET { 25.9, -9.4, -1.6 } // DCI Probe front mount
...
#define INVERT_E0_DIR false //stock extruder on skr
