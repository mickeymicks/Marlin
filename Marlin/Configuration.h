...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  39.24 //Duplicator 6 Mod
    #define DEFAULT_Ki   2.20
    #define DEFAULT_Kd 175.40
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.55 // Duplicator 6
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.84, 80.84, 800.96, 186.63 }
